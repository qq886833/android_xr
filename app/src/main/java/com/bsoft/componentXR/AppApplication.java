    ...
    public void onCreate() {
        ...
        BaseAppInit.getInstance().init(this, getConfig(), new InitListener() {
            ...
            public void needLogin(String path, Bundle param) {
                //TODO 需要登录
                ToastUtil.toast(R.string.common_common_not_login);
            }

            @Override
            public void tokenError() {
                ToastUtil.toast(R.string.common_common_account_error);
                //TODO token失效
            }
            ...
            public void userInfoError(String path, Bundle param) {
                //TODO 未完善信息
                ToastUtil.toast(R.string.common_common_account_not_perfect);
            }
        });
    }
