package com.bsoft.baselib.base.pictureShow.fresco.view;
...
public class ImageLoadingDrawable extends Drawable {
    ...
    public ImageLoadingDrawable(int mRadius, int mStrokeWidth,int mRingBackgroundColor, int mRingColor){
        this.mRadius = mRadius;
        this.mStrokeWidth = mStrokeWidth;
        this.mRingBackgroundColor = mRingBackgroundColor;
