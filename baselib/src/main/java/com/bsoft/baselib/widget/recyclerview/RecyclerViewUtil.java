package com.bsoft.baselib.widget.recyclerview;

import android.annotation.SuppressLint;
import android.content.Context;

import com.bsoft.baselib.R;
import com.bsoft.baselib.thirdpart.recyclerviewDivider.HorizontalDividerItemDecoration;
import com.bsoft.baselib.thirdpart.recyclerviewDivider.VerticalDividerItemDecoration;
...
public class RecyclerViewUtil {
    ...
    public static void initLinearV(Context baseContext, RecyclerView recyclerview) {
        initLinearV(baseContext, recyclerview, R.color.base_core_transparent, R.dimen.dp_0, R.dimen.dp_0, R.dimen.dp_0);
    }
    ...
    public static void initLinearH(Context baseContext, RecyclerView recyclerview) {
        initLinearH(baseContext, recyclerview, R.color.base_core_transparent, R.dimen.dp_0, R.dimen.dp_0, R.dimen.dp_0);
    }
    ...
    public static void initGrid(Context baseContext, RecyclerView rv, int gridColumn) {
        initGrid(baseContext, rv, gridColumn,
                R.color.base_core_transparent, R.dimen.dp_0, R.dimen.dp_0, R.dimen.dp_0,
                R.color.base_core_transparent, R.dimen.dp_0, R.dimen.dp_0, R.dimen.dp_0
        );
    }
