...
public class CardTypeDic {
    ...
    public static String getIdcardText(String type) {
        if (TextUtils.equals(IDCARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_idcard);
        } else if (TextUtils.equals(HOUSE_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_house_card);
        } else if (TextUtils.equals(PASSPORT, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_passport);
        } else if (TextUtils.equals(OFFICER_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_officer_card);
        } else if (TextUtils.equals(DRIVING_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_driving_card);
        } else if (TextUtils.equals(HONGKONG_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_hongkong_card);
        } else if (TextUtils.equals(TAIWAN_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_taiwan_card);
        } else if (TextUtils.equals(BIRTH_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_birth_card);
        } else if (TextUtils.equals(OTHER_CARD, type)) {
            return CoreAppInit.getApplication().getString(R.string.common_other_card);
        } else {
            return null;
        }
    }
