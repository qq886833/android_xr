...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final String DEFAULT_EXPAND_STR = "展开";
    private static final String DEFAULT_COLLAPSED_STR = "收起";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mContentTextSize = typedArray.getInt(R.styleable.ExpandableTextView_contentTextSize, DEFAULT_CONTENT_TEXT_SIZE);
        ...
        mContentText = typedArray.getString(R.styleable.ExpandableTextView_contentText);
...
//        }
        ...
        if (mExpandString == null) {
            mExpandString = DEFAULT_EXPAND_STR;
        }
        if (mCollapsedString == null) {
            mCollapsedString = DEFAULT_COLLAPSED_STR;
        }
