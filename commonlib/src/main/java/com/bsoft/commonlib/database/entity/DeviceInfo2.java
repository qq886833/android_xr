package com.bsoft.commonlib.database.entity;
...
public class DeviceInfo2 extends CoreVo {
    ...
    @Generated(hash = 1427530671)
    public DeviceInfo2(Long id, String phoneCompany, String phoneModel,
