...
public class AppUtil {
    ...
    public static String getAppName() {
        try {
            PackageManager packageManager = CoreAppInit.getApplication().getPackageManager();
            PackageInfo packageInfo = packageManager.getPackageInfo(
                    CoreAppInit.getApplication().getPackageName(), 0);
            int labelRes = packageInfo.applicationInfo.labelRes;
            return CoreAppInit.getApplication().getResources().getString(labelRes);
    ...
    public static boolean isGpsEnabled() {
        LocationManager lm = (LocationManager) CoreAppInit.getApplication().getSystemService(Context.LOCATION_SERVICE);
    ...
    public static String getStoreDir() {
        File f = CoreAppInit.getApplication().getExternalFilesDir("");
//            File f = this.getExternalCacheDir();
    ...
    public static String getCacheDir(String dirStr) {
        File f = CoreAppInit.getApplication().getExternalCacheDir();
        if (null != f) {
            StringBuffer path = new StringBuffer();
    ...
    public static boolean isInstalled(String packageName) {
        PackageManager manager = CoreAppInit.getApplication().getPackageManager();
        //获取所有已安装程序的包信息
