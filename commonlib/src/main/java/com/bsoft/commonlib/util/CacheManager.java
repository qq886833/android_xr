...
/**
 * Created by chenkai on 2018/7/10.
 */
...
public class CacheManager {
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(
            ...
            deleteFolderFile(context.getExternalCacheDir().getPath(), false);
        }
    }
    ...
    public static void cleanExternalFilesDir(Context context) {
        if (Environment.getExternalStorageState().equals(
                Environment.MEDIA_MOUNTED)) {
            deleteFolderFile(context.getExternalFilesDir("").getPath(), false);
        }
    }
    ...
    public static String getCacheSize(Context context) throws Exception {
        ...
        size = size + getFolderSize(context.getExternalFilesDir(""));
